...
router.get('/', function(req, res, next) {
  res.render('ex-5',
    { title: 'Aufgabe 5',
      description: 'Das Schema aus Aufgabe 4 soll nun erweitert werden. Ziel dieser Aufgabe ist es, einen Interpreten ' +
      'zu beschreiben. Es soll mindestens der Name des Interpreten (name), das Gründungsjahr (founded_in), und eine ' +
